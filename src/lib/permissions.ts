...
export const VIEWS: ViewDef[] = [
  ...
  { key: 'politicas_reserva', label: 'Políticas de reserva', group: 'Principal', path: '/politicas-reserva' },
  ...
  { key: 'reservas.operacion.payment_amount_change', label: 'Corregir importe de pago', group: 'Acciones · Estancias', parent: 'reservas' },
  ...
  { key: 'reservas.operacion.reactivate_reservation', label: 'Reactivar reserva cancelada o no-show', group: 'Acciones · Estancias', parent: 'reservas' },
...
export const DEFAULT_PERMISSIONS: PermissionMatrix = {
  ...
  politicas_reserva: ['Admin', 'Gerente'],
  ...
  'reservas.operacion.payment_amount_change': ['Admin', 'Gerente'],
  ...
  'reservas.operacion.reactivate_reservation': ['Admin', 'Gerente'],
};
