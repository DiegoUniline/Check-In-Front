    ...
    >
      <div className="mx-auto flex h-16 w-full max-w-[1360px] items-center justify-between px-6 md:h-[72px] md:px-10 lg:px-14">
                ...
                <AnimatePresence>
                  {openMega && (
                    <motion.div
                      ...
                      className="absolute left-1/2 top-full mt-3 w-[860px] -translate-x-1/2 rounded-[8px] border border-border/70 bg-background/95 p-6 shadow-[0_30px_60px_-30px_rgba(15,23,42,0.25)] backdrop-blur-xl"
                    >
        ...
        <div className="hidden items-center gap-2 md:flex">
          <Link
            to="/login"
            className="rounded-md px-4 py-2 text-[14px] font-medium text-foreground/80 transition-colors hover:text-foreground"
          >
            Iniciar sesión
          </Link>
          <Link
            to="/signup"
            className="inline-flex items-center gap-1.5 rounded-md bg-foreground px-5 py-2.5 text-[14px] font-medium text-background transition-transform hover:scale-[1.02]"
          >
            Comenzar
          ...
          >
            <div className="mx-auto flex w-full max-w-[1360px] flex-col gap-1 px-6 py-4">
              ...
              <div className="mt-2 flex gap-2 border-t border-border/60 pt-4">
                <Link
                  to="/login"
                  className="flex-1 rounded-md border border-border px-4 py-3 text-center text-sm font-medium"
                >
                  Iniciar sesión
                </Link>
                <Link
                  to="/signup"
                  className="flex-1 rounded-md bg-foreground px-4 py-3 text-center text-sm font-medium text-background"
                >
                  Comenzar
                </Link>
              </div>
