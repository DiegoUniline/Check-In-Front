            ...
            <Table className="min-w-[800px]">
              <TableHeader>
                <TableRow>
                  ...
                  <SortHeader label="Tipo" columnKey="tipo" sortKey={dt.sortKey} sortDir={dt.sortDir} onSort={dt.toggleSort} filterValue={dt.filters.tipo} onFilterChange={(v) => dt.setColumnFilter('tipo', v)} onValuesChange={(vs) => dt.setColumnFilterValues('tipo', vs)} filterOptions={filteredHabitaciones.map((h: any) => h.tipo)} />
