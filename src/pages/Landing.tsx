    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/80 backdrop-blur-2xl">
      <div className="mx-auto flex h-16 max-w-[1320px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <Link to="/login" className="rounded-md px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">Iniciar sesión</Link>
          <a href={WA_DEMO} target="_blank" rel="noreferrer" className="rounded-md px-5 py-2.5 text-sm font-semibold text-white shadow-[0_10px_30px_-10px_rgba(249,115,22,.8)] transition hover:-translate-y-0.5" style={{ background: ORANGE }}>Agendar demo</a>
        </div>
...
function AnimatedProduct() {
  return (
    <div className="relative mx-auto w-full max-w-[660px]">
      <motion.div animate={{ y: [0, -8, 0] }} transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }} className="relative overflow-hidden rounded-[8px] border border-white/80 bg-white shadow-[0_40px_120px_-35px_rgba(15,35,63,.45)]">
